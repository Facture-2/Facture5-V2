    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Heatmap des Activités Fournisseurs</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">Visualisation mensuelle des {viewMode === 'orders' ? 'commandes' : 'paiements'}</p>
          </div>
